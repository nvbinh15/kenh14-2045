// Batch hero-image generator for Kenh14 2045 satirical project.
...
// Kenh14 is glossier and more vibrant than a wire-photo paper — push the
// styles toward saturated editorial entertainment imagery.
const STYLE_PHOTO =
  "vibrant glossy entertainment photography, saturated colours, punchy contrast, Vietnamese youth-culture / showbiz setting, magazine cover energy, shallow depth of field, no text or logos in image";
const STYLE_ILLUSTRATION =
  "bold colourful editorial illustration, playful Gen-Z aesthetic, vivid magenta and neon palette, clean shapes, Vietnamese pop-culture details, no text";
